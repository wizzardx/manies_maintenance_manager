...
from marnies_maintenance_manager.users.views import UserRedirectView
from marnies_maintenance_manager.users.views import UserUpdateView
from marnies_maintenance_manager.users.views import user_detail_view
