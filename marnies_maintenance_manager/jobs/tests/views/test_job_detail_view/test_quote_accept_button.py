...
class TestAcceptQuoteButtonVisibility:
    ...
    @staticmethod
    def test_agent_can_see_accept_quote_button_when_marnie_has_uploaded_quote(
    ...
    @staticmethod
    def test_button_not_visible_when_marnie_has_not_uploaded_quote(
    ...
    @staticmethod
    def test_marnie_cannot_see_accept_quote_button_after_uploading_quote(
        bob_job_with_quote: Job,
        marnie_user_client: Client,
    ) -> None:
        """Ensure Marnie can't see the accept quote button after uploading a quote.
