"""This module provides mixins for views in the Marnie's Maintenance Manager project.
...
class JobSuccessUrlMixin:
    ...
    def get_success_url(self: ViewProtocol) -> str:
        ...
        If the user is Marnie, include the agent's username in the URL query parameters.
