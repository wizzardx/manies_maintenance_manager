...
SECRET_KEY = env(
    "DJANGO_SECRET_KEY",
    default="gz5nFljo5lyAE14FzVkmvGdbdKrYgUIPTlb1Zm6zIxMy55RFAOcOFOOWXUDfqaEU",
)
...
if env("USE_DOCKER") == "yes":  # pylint: disable=magic-value-comparison
    import socket
...
for template in TEMPLATES:
    ...
    options = check_type(options, dict[str, Any])
    options["debug"] = True
