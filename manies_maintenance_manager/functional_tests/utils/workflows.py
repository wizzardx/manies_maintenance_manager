...
from .job_creation import _bob_accepts_manies_quote
from .job_creation import _bob_submits_deposit_pop
from .job_creation import _create_new_job
from .job_creation import _manie_does_onsite_work_then_uploads_his_final_docs
...
def _workflow_from_new_job_to_completed_by_manie(
    browser: WebDriver,
    live_server_url: str,
) -> None:
    ...
    ## After that, Manie completes the job and uploads a final invoice.
    _manie_does_onsite_work_then_uploads_his_final_docs(browser)
...
def _workflow_from_new_job_to_final_pop_added_by_bob(
    ...
    # has been submitted successfully, and that Manie has been emailed.
    expected_message = (
