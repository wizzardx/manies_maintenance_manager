...
from manies_maintenance_manager.functional_tests.utils.date_utils import (
...
def test_get_crispy_forms_date_input_format_ddmmyyyy(mocker: MockerFixture) -> None:
    ...
    """
    mocker.patch(
        "manies_maintenance_manager.functional_tests.utils.date_utils.get_date_format_from_locale",
        return_value="%d/%m/%Y",
    )
