...
class Command(BaseCommand):
    ...
    def create_users_and_data(self) -> None:
        ...
        # Make the Manie user.
        if not _user_exists("manie"):
            make_test_user(User, "manie", is_manie=True)
            self.stdout.write(self.style.SUCCESS("Successfully created user manie"))
        else:
            logging.debug("User manie already exists")
