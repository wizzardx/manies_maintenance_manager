...
from manies_maintenance_manager.jobs.forms import JobCompleteOnsiteWorkForm
...
class JobCompleteOnsiteWorkView(
    ...
    def test_func(self) -> bool:
        ...
        """
        # Only Manie and Admin users can reach this view, and only if the job has
        # not yet been completed by Manie.
    ...
    def form_valid(self, form: JobCompleteOnsiteWorkForm) -> HttpResponse:
        ...
        # Update the Job's state to "manie completed onsite work"
        ...
        # Email the agent.
        email_subject = "Manie completed onsite work on a maintenance job"

        email_body = (
            "Manie completed the onsite maintenance work on "
