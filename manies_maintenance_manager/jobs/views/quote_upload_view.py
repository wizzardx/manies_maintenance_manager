...
from manies_maintenance_manager.jobs.forms import QuoteUploadForm
...
class QuoteUploadView(
    ...
    def form_valid(self, form: QuoteUploadForm) -> HttpResponse:
        ...
        # In this part, we email the agent, notifying him that Manie has uploaded the
        # quote.
        email_subject = "Manie uploaded a quote for your maintenance request"
        email_body = (
