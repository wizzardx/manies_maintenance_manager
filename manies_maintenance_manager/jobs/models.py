"""Models for managing jobs in the Manie's Maintenance Manager application."""
...
class Job(UUIDModel, TimeStampedModel):
    ...
    class Status(Enum):
        ...
        MANIE_COMPLETED_ONSITE_WORK = "manie_completed_onsite_work"
        MANIE_SUBMITTED_DOCUMENTATION = "manie_submitted_documentation"
    ...
    STATUS = Choices(  # type: ignore[no-untyped-call]
        ...
        (
            Status.MANIE_COMPLETED_ONSITE_WORK.value,
            _("Manie has completed the onsite work"),
        ),
        (
            Status.MANIE_SUBMITTED_DOCUMENTATION.value,
            _("Manie submitted final documentation"),
        ),
        (
    ...
    # This field records whether Manies quote was accepted or rejected by the
    # agent.
