...
from manies_maintenance_manager.jobs.views.final_payment_pop_update_view import (
...
def test_view_has_correct_basic_structure(
    ...
    Args:
        bob_job_with_manie_final_documentation (Job): A Job instance where Manie has
...
def test_manie_user_cannot_access_view(
    bob_job_with_manie_final_documentation: Job,
    manie_user_client: Client,
) -> None:
    """Ensure Manie cannot access the "Upload Final Payment POP" view.
...
def test_view_accessible_if_job_in_manie_completed_state(
    bob_job_with_manie_final_documentation: Job,
    bob_agent_user_client: Client,
) -> None:
    """Block view if job isn't in the "Completed by Manie" state.
...
def test_view_accessible_if_job_in_manie_uploaded_final_documentation_state(
    bob_job_with_manie_final_documentation: Job,
    bob_agent_user_client: Client,
) -> None:
    """Ensure view access if job is in the "Manie uploaded final documentation" state.
...
def test_view_not_accessible_if_final_payment_pop_already_uploaded(
    ...
    Args:
        bob_job_with_manie_final_documentation (Job): A Job instance where Manie
    ...
    with safe_read(test_pdf):
        bob_job_with_manie_final_documentation.save()
