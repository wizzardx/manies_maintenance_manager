...
# Manie can see the link.
def test_manie_can_see_link(bob_job_with_deposit_pop: Job, manie_user: User) -> None:
    """Ensure that Manie can see the link.
    ...
    """
    job = bob_job_with_deposit_pop
    link = get_deposit_pop_link(manie_user, job)
    assert link is not None
